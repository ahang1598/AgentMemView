...
export type AgentMemViewDatabase = InstanceType<typeof Database>;

/**
 * Open the single-file SQLite database with the AgentMemView baseline pragmas:
 ...
 */
export function openDatabase(path: string): AgentMemViewDatabase {
