...
import { configSchema, type MemokitConfig } from "./schema.js";
...
export interface LoadConfigResult {
  config: MemokitConfig;
  warnings: string[];
}

export type ConfigChangeHandler = (config: MemokitConfig) => void;

const WATCH_DEBOUNCE_MS = 200;

/**
 * Load and validate `memokit.config.yaml`.
